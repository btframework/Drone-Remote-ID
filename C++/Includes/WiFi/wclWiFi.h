...
namespace wclWiFi
{
	...
	protected:
		/// <summary> The function requests access to the WiFi features on Win 11
		///   24H2 and above. </summary>
	...
	class CwclCustomWiFiMemoryComponent : public CwclCustomWiFiComponent
	{
	...
	/// <seealso cref="CwclCustomWiFiComponent" />
	class CwclWiFiClient : public CwclCustomWiFiComponent
	{
	...
	/// <summary> Describes the Wi-Fi interface parameter. </summary>
	typedef struct
	{
		/// <summary> The parameter name. </summary>
		tstring		Name;
		/// <summary> The parameter display name. </summary>
		tstring		DisplayName;
		/// <summary> The parameter default value. </summary>
		tstring		Default;
	} wclWiFiInterfaceParameter;
	/// <summary> Array of the Wi-Fi interface paramaters. </summary>
	/// <seealso cref="wclWiFiInterfaceParameter" />
	typedef std::vector<wclWiFiInterfaceParameter> wclWiFiInterfaceParameters;
	...
	private:
		...
		// Opens the interface's registry key.
		void OpenKey();
	...
	public:
		...
		/// <summary> Enumerates supported interface parameters. </summary>
		/// <param name="Params"> The dynamic array of the
		///   <see cref="wclWiFiInterfaceParameter" /> structures which receives
		///   the returned list of the interface supported parameters. </param>
		/// <returns> <para> If the function succeeds, the return value is
		///   <see cref="WCL_E_SUCCESS" />. </para>
		///   <para> If the function fails, the return value may be one of the WCL
		///   error codes. </para> </returns>
		/// <remarks> An application is responsible for releasing a memory
		///   allocated for the <c>Params</c> dynamic array. </remarks>
		/// <seealso cref="wclWiFiInterfaceParameters" />
		int EnumParams(wclWiFiInterfaceParameters& Params);
		...
		///   <para> If the function fails, the return value may be one of the WCL
		///   error codes. </para> </returns>
		int GetParamValue(const tstring& Name, tstring& Value);
		/// <summary> Get list of available parameter values. </summary>
		/// <param name="Name"> The parameter name. </param>
		/// <param name="Values"> The list of the parameter values. </param>
		/// <returns> <para> If the function succeeds, the return value is
		///   <see cref="WCL_E_SUCCESS" />. </para>
		///   <para> If the function fails, the return value may be one of the WCL
		///   error codes. </para> </returns>
		int GetParamValues(const tstring& Name, std::vector<tstring>& Values);
		/// <summary> Sets the parameter value. </summary>
		/// <param name="Name"> The parameter name. </param>
		...
		///   <para> If the function fails, the return value may be one of the WCL
		///   error codes. </para> </returns>
		/// <remarks> Administrative rights required to execute this
		///   method. </remarks>
		int SetParamValue(const tstring& Name, const tstring& Value);
	...
	///   component. </remarks>
	/// <seealso cref="CwclCustomWiFiMemoryComponent" />
	...
	/// <summary> Client accepting mode for the Wi-Fi Direct Software Access
	///   Point. </summary>
	typedef enum
	{
		/// <summary> Manual accept mode. When client connects the
		///   <c>OnDeviceAccept</c> event will be called. </summary>
		amManual,
		/// <summary> The White List accept mode. Only the devices that are in the
		///   list will be accepted. </summary>
		amWhiteList,
		/// <summary> The Black List accept mode. Only the device that are not in
		///   the list will be accepted. </summary>
		amBlackList
	} wclWiFiSoftAPAcceptMode;

	/// <summary> The devices MAC list. </summary>
	typedef std::list<tstring> CwclWiFiDevicesList;
	...
	private:
		...
		wclWiFiSoftAPAcceptMode		FAcceptMode;
		CwclWiFiDevicesList*		FDevices;
	...
	public:
		...
		/// <summary> Gets the list of the devices. </summary>
		/// <returns> The devices list. </returns>
		/// <remarks> The string list contains the MAC addresses of the devices that
		///   will be used as Black or White list depending on the selected
		///   accept mode. </remarks>
		/// <seealso cref="wclWiFiSoftAPAcceptMode" />
		/// <seealso cref="CwclWiFiDevicesList" />
		CwclWiFiDevicesList* GetDevices() const;
		/// <summary> Gets the list of the devices. </summary>
		/// <value> The devices list. </value>
		/// <remarks> The string list contains the MAC addresses of the devices that
		///   will be used as Black or White list depending on the selected
		///   accept mode. </remarks>
		/// <seealso cref="wclWiFiSoftAPAcceptMode" />
		/// <seealso cref="CwclWiFiDevicesList" />
		__declspec(property(get = GetDevices)) CwclWiFiDevicesList* FDevices;

		/// <summary> Gets the accept mode. </summary>
		/// <returns> The current accept mode. </returns>
		/// <seealso cref="wclWiFiSoftAPAcceptMode" />
		wclWiFiSoftAPAcceptMode GetAcceptMode() const;
		/// <summary> Sets the accept mode. </summary>
		/// <param name="Value"> The current accept mode. </param>
		/// <seealso cref="wclWiFiSoftAPAcceptMode" />
		void SetAcceptMode(const wclWiFiSoftAPAcceptMode Value);
		/// <summary> Gets and sets the accept mode. </summary>
		/// <value> The current accept mode. </value>
		/// <seealso cref="wclWiFiSoftAPAcceptMode" />
		__declspec(property(get = GetAcceptMode, put = SetAcceptMode)) wclWiFiSoftAPAcceptMode AcceptMode;
