...
namespace wclWiFi
{
	...
	/// <summary> The feature is not supported by the Wi-Fi interface. </summary>
	const int WCL_E_WIFI_INTERFACE_FEATURE_NOT_SUPPORTED = WCL_E_WIFI_INTERFACE_BASE + 0x0008;
	/// <summary> Unable to open the Wi-Fi interface parameters registry key. </summary>
	const int WCL_E_WIFI_INTERFACE_KEY_OPEN_FAILED = WCL_E_WIFI_INTERFACE_BASE + 0x0009;
	/// <summary> The interface does not have any configurable parameters. </summary>
	const int WCL_E_WIFI_INTERFACE_NO_PARAMETERS = WCL_E_WIFI_INTERFACE_BASE + 0x000A;
	/// <summary> A parameter with the specified name was not found. </summary>
	const int WCL_E_WIFI_INTERFACE_PARAMETER_NOT_FOUND = WCL_E_WIFI_INTERFACE_BASE + 0x000B;
	/// <summary> Read parameter raw value failed. </summary>
	const int WCL_E_WIFI_INTERFACE_PARAMETER_READ_FAILED = WCL_E_WIFI_INTERFACE_BASE + 0x000C;
	/// <summary> Unable to find a paratemer value. </summary>
	const int WCL_E_WIFI_INTERFACE_PARAMETER_FIND_VALUE_FAILED = WCL_E_WIFI_INTERFACE_BASE + 0x000D;
	/// <summary> Unable to read a paratemer value. </summary>
	const int WCL_E_WIFI_INTERFACE_PARAMETER_READ_VALUE_FAILED = WCL_E_WIFI_INTERFACE_BASE + 0x000E;
	/// <summary> Invalid parameter value. </summary>
	const int WCL_E_WIFI_INTERFACE_INVALID_VALUE = WCL_E_WIFI_INTERFACE_BASE + 0x000F;
	/// <summary> Update parameter value failed. </summary>
	const int WCL_E_WIFI_INTERFACE_SET_VALUE_FAILED = WCL_E_WIFI_INTERFACE_BASE + 0x0010;
	/// <summary> The Wi-Fi interface was not found. </summary>
	const int WCL_E_WIFI_INTRFACE_NOT_FOUND = WCL_E_WIFI_INTERFACE_BASE + 0x0011;
	/// <summary> Unable to disable the Wi-Fi interface. </summary>
	const int WCL_E_WIFI_INTRFACE_DISABLE_FAILED = WCL_E_WIFI_INTERFACE_BASE + 0x0012;
	/// <summary> Unable to enable the Wi-Fi interface. </summary>
	const int WCL_E_WIFI_INTRFACE_ENABLE_FAILED = WCL_E_WIFI_INTERFACE_BASE + 0x0013;
